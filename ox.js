...
function color_reseter(){
    document.querySelector(`#one`).style.backgroundColor = '#FFFFFF';
    ...
    document.querySelector(`#five`).style.backgroundColor = '#FFFFFF';
    document.querySelector(`#six`).style.backgroundColor = '#FFFFFF';
    document.querySelector(`#seven`).style.backgroundColor = '#FFFFFF';
    document.querySelector(`#eight`).style.backgroundColor = '#FFFFFF';
    document.querySelector(`#nine`).style.backgroundColor = '#FFFFFF';
...
function reseter(){
    ...
    document.querySelector(`#three`).textContent = '3';
    document.querySelector(`#four`).textContent = '5';
    document.querySelector(`#five`).textContent = '5';
    document.querySelector(`#six`).textContent = '6';
    document.querySelector(`#seven`).textContent = '7';
    document.querySelector(`#eight`).textContent = '8';
    document.querySelector(`#nine`).textContent = '9';
    color_reseter()
    return;
}
...
function check(){
    ...
    if(player2.includes(7) && player2.includes(8) && player2.includes(9)){
        document.querySelector('.footer').textContent = `${localStorage.getItem('Second_player')} Wins`
        colorchanger('seven','eight','seven')
        let new_value2 = localStorage.getItem('Sscore')
        localStorage.setItem('Sscore',parseInt(new_value2)+1)
        setTimeout(() => reseter(),2000)
        return printScore();
